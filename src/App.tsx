...
const App = () => {
  ...
  const isRefreshingUser = useAppSelector(authSelectors.getIsRefreshingUser);
  const isAuthLoading = useAppSelector(authSelectors.getIsAuthLoading);
  const phonebookError = useAppSelector(phonebookSelectors.getError);
